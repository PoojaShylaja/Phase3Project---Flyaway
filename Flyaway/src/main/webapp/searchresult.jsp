...
<html>
<head>
<link rel="stylesheet" type="text/css" href="style/style4.css?version=51">
        ...
        <tr bgcolor="black">
            ...
            <td>
                <form action="${pageContext.request.contextPath}/bookflight.jsp" method="post">
                    ...
                    <input type="submit" class="btn btn-success" value="Book This Flight" id=Submit>
                </form>
            </td>
        </tr>
        <%
